                    ...
                    <div class="body-box">
                        ...
                        <div class="botoes">
                            ...
                            <div class="formContainer">
                                <p class="alert alert-success condicao">
                                ...
                                <form method="post">
                                    ...
                                    <div class="btn-group" role="group">
                                        ...
                                        <input class="btn btn-secondary margin" type="submit" name="indisponibilizar" value="Indispolibilizar" id="atualizar" data-toggle="tooltip" data-placement="top" title="Tornar imóvel indisponível.">
                                    </div>
                                </form>
                            </div>
                        </div>
